<template name="graceMaskView">
	<view class="grace-mask" v-if="show" >
		<view class="grace-mask-view" :style="{width: width}" v-if="show">
			...
			<view class="grace-mask-view-content" @tap="test" :style="{background:bgcolor}">
				<slot></slot>
			</view>
		</view>
	</view>
...
.grace-mask-view{width:80%; position:fixed; left:50%; top:45%; border-radius:6px; z-index:99; transform: translate(-50%, -50%);}
.grace-mask-close{width:100%; height:40px; text-align:right; color:#FFF;}
